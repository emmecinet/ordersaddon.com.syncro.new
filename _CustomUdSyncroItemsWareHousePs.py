...
from _CustomUdClassFtp import CustomUdFtp #custom
...
class SyncroItemsWareHouse:
    ...
    def syncro():
        ...
        nameFileJson = 'Custom.Ud.Syncro.ItemsWareHouse.json'
        table = "ARZ"
        ...
        CustomUdFtp.upload(configPath+'/temp/'+nameFileJson,'import/'+nameFileJson)
        CustomUdFtp.upload(configPath+'/temp/'+nameFileJson,'log/'+curDateTime+"_"+nameFileJson)
